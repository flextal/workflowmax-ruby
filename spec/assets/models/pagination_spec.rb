...
# Unit tests for WorkflowMaxRuby::Assets::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Pagination' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Assets::Pagination.new
  end
  ...
  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Assets::Pagination)
    end
  end
