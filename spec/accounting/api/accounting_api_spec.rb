...
# Unit tests for WorkflowMaxRuby::AccountingApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountingApi' do
  before do
    # run before each test
    @api_instance = WorkflowMaxRuby::AccountingApi.new
  end
  ...
  describe 'test an instance of AccountingApi' do
    it 'should create an instance of AccountingApi' do
      expect(@api_instance).to be_instance_of(WorkflowMaxRuby::AccountingApi)
    end
  end
