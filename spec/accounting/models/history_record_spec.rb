...
# Unit tests for WorkflowMaxRuby::Accounting::HistoryRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HistoryRecord' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::HistoryRecord.new
  end
  ...
  describe 'test an instance of HistoryRecord' do
    it 'should create an instance of HistoryRecord' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::HistoryRecord)
    end
  end
