...
# Unit tests for WorkflowMaxRuby::Accounting::Employee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Employee' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Employee.new
  end
  ...
  describe 'test an instance of Employee' do
    it 'should create an instance of Employee' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Employee)
    end
  end
