...
# Unit tests for WorkflowMaxRuby::Accounting::ManualJournalLine
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ManualJournalLine' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::ManualJournalLine.new
  end
  ...
  describe 'test an instance of ManualJournalLine' do
    it 'should create an instance of ManualJournalLine' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::ManualJournalLine)
    end
  end
