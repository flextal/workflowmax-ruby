...
# Unit tests for WorkflowMaxRuby::Accounting::Journal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Journal' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Journal.new
  end
  ...
  describe 'test an instance of Journal' do
    it 'should create an instance of Journal' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Journal)
    end
  end
