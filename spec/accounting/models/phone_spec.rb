...
# Unit tests for WorkflowMaxRuby::Accounting::Phone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Phone' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Phone.new
  end
  ...
  describe 'test an instance of Phone' do
    it 'should create an instance of Phone' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Phone)
    end
  end
