...
# Unit tests for WorkflowMaxRuby::Accounting::AccountsPayable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountsPayable' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::AccountsPayable.new
  end
  ...
  describe 'test an instance of AccountsPayable' do
    it 'should create an instance of AccountsPayable' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::AccountsPayable)
    end
  end
