...
# Unit tests for WorkflowMaxRuby::Accounting::Payment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Payment' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Payment.new
  end
  ...
  describe 'test an instance of Payment' do
    it 'should create an instance of Payment' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Payment)
    end
  end
