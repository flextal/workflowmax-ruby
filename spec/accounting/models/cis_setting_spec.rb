...
# Unit tests for WorkflowMaxRuby::Accounting::CISSetting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CISSetting' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::CISSetting.new
  end
  ...
  describe 'test an instance of CISSetting' do
    it 'should create an instance of CISSetting' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::CISSetting)
    end
  end
