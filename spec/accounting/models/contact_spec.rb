...
# Unit tests for WorkflowMaxRuby::Accounting::Contact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Contact' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Contact.new
  end
  ...
  describe 'test an instance of Contact' do
    it 'should create an instance of Contact' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Contact)
    end
  end
