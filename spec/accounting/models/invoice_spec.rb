...
# Unit tests for WorkflowMaxRuby::Accounting::Invoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Invoice' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Invoice.new
  end
  ...
  describe 'test an instance of Invoice' do
    it 'should create an instance of Invoice' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Invoice)
    end
  end
