...
# Unit tests for WorkflowMaxRuby::Accounting::Quote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Quote' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Quote.new
  end
  ...
  describe 'test an instance of Quote' do
    it 'should create an instance of Quote' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Quote)
    end
  end
