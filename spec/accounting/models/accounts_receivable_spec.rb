...
# Unit tests for WorkflowMaxRuby::Accounting::AccountsReceivable
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountsReceivable' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::AccountsReceivable.new
  end
  ...
  describe 'test an instance of AccountsReceivable' do
    it 'should create an instance of AccountsReceivable' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::AccountsReceivable)
    end
  end
