...
# Unit tests for WorkflowMaxRuby::Accounting::TrackingCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrackingCategory' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::TrackingCategory.new
  end
  ...
  describe 'test an instance of TrackingCategory' do
    it 'should create an instance of TrackingCategory' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::TrackingCategory)
    end
  end
