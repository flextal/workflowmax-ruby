...
# Unit tests for WorkflowMaxRuby::Accounting::CISOrgSetting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CISOrgSetting' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::CISOrgSetting.new
  end
  ...
  describe 'test an instance of CISOrgSetting' do
    it 'should create an instance of CISOrgSetting' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::CISOrgSetting)
    end
  end
