...
# Unit tests for WorkflowMaxRuby::Accounting::ExpenseClaim
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExpenseClaim' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::ExpenseClaim.new
  end
  ...
  describe 'test an instance of ExpenseClaim' do
    it 'should create an instance of ExpenseClaim' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::ExpenseClaim)
    end
  end
