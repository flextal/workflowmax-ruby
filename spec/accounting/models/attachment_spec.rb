...
# Unit tests for WorkflowMaxRuby::Accounting::Attachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Attachment' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Attachment.new
  end
  ...
  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Attachment)
    end
  end
