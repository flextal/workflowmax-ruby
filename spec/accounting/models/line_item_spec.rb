...
# Unit tests for WorkflowMaxRuby::Accounting::LineItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LineItem' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::LineItem.new
  end
  ...
  describe 'test an instance of LineItem' do
    it 'should create an instance of LineItem' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::LineItem)
    end
  end
