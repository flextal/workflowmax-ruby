...
# Unit tests for WorkflowMaxRuby::Accounting::Account
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Account' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Account.new
  end
  ...
  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Account)
    end
  end
