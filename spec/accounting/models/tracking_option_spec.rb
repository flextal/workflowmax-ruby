...
# Unit tests for WorkflowMaxRuby::Accounting::TrackingOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TrackingOption' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::TrackingOption.new
  end
  ...
  describe 'test an instance of TrackingOption' do
    it 'should create an instance of TrackingOption' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::TrackingOption)
    end
  end
