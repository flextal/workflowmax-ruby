...
# Unit tests for WorkflowMaxRuby::Accounting::Purchase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Purchase' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Purchase.new
  end
  ...
  describe 'test an instance of Purchase' do
    it 'should create an instance of Purchase' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Purchase)
    end
  end
