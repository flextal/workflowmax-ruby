...
# Unit tests for WorkflowMaxRuby::Accounting::ExternalLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ExternalLink' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::ExternalLink.new
  end
  ...
  describe 'test an instance of ExternalLink' do
    it 'should create an instance of ExternalLink' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::ExternalLink)
    end
  end
