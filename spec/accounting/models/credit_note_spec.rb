...
# Unit tests for WorkflowMaxRuby::Accounting::CreditNote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreditNote' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::CreditNote.new
  end
  ...
  describe 'test an instance of CreditNote' do
    it 'should create an instance of CreditNote' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::CreditNote)
    end
  end
