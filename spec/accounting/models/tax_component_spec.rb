...
# Unit tests for WorkflowMaxRuby::Accounting::TaxComponent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaxComponent' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::TaxComponent.new
  end
  ...
  describe 'test an instance of TaxComponent' do
    it 'should create an instance of TaxComponent' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::TaxComponent)
    end
  end
