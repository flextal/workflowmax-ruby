...
# Unit tests for WorkflowMaxRuby::Accounting::PurchaseOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PurchaseOrder' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::PurchaseOrder.new
  end
  ...
  describe 'test an instance of PurchaseOrder' do
    it 'should create an instance of PurchaseOrder' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::PurchaseOrder)
    end
  end
