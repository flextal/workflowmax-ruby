...
# Unit tests for WorkflowMaxRuby::Accounting::BankTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'BankTransaction' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::BankTransaction.new
  end
  ...
  describe 'test an instance of BankTransaction' do
    it 'should create an instance of BankTransaction' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::BankTransaction)
    end
  end
