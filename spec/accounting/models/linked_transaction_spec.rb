...
# Unit tests for WorkflowMaxRuby::Accounting::LinkedTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'LinkedTransaction' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::LinkedTransaction.new
  end
  ...
  describe 'test an instance of LinkedTransaction' do
    it 'should create an instance of LinkedTransaction' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::LinkedTransaction)
    end
  end
