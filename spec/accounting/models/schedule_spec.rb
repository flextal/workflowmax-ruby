...
# Unit tests for WorkflowMaxRuby::Accounting::Schedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Schedule' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Schedule.new
  end
  ...
  describe 'test an instance of Schedule' do
    it 'should create an instance of Schedule' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Schedule)
    end
  end
