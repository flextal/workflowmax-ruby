...
# Unit tests for WorkflowMaxRuby::Accounting::ContactGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContactGroup' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::ContactGroup.new
  end
  ...
  describe 'test an instance of ContactGroup' do
    it 'should create an instance of ContactGroup' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::ContactGroup)
    end
  end
