...
# Unit tests for WorkflowMaxRuby::Accounting::Organisation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Organisation' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Organisation.new
  end
  ...
  describe 'test an instance of Organisation' do
    it 'should create an instance of Organisation' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Organisation)
    end
  end
