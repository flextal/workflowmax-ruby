...
# Unit tests for WorkflowMaxRuby::Accounting::Receipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Receipt' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Accounting::Receipt.new
  end
  ...
  describe 'test an instance of Receipt' do
    it 'should create an instance of Receipt' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Accounting::Receipt)
    end
  end
