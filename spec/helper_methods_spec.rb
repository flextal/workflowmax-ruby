...
describe 'shared helper methods' do
  ...
  describe '#parse_date' do
    let(:model_instance) {WorkflowMaxRuby::Accounting::Account.new}
  ...
  describe '#to_hash' do
    let(:invoice) {
      WorkflowMaxRuby::Accounting::Invoice.new(
        type: 'ACCPAY',
        total_discount: 100,
    ...
    let(:contact) {
      WorkflowMaxRuby::Accounting::Contact.new(
        account_number: 'abc-123',
        contact_status: WorkflowMaxRuby::Accounting::Contact::ACTIVE,
        name: 'Contact Name',
        first_name: 'Contact',
        last_name: 'Name',
    ...
    let(:contact_capitalized_with_nested_objects) {
      WorkflowMaxRuby::Accounting::Contact.new({
        ...
        phones: [
          WorkflowMaxRuby::Accounting::Phone.new({
            phone_type: "MOBILE",
