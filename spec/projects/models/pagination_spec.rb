...
# Unit tests for WorkflowMaxRuby::Projects::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Pagination' do
  before do
    # run before each test
    @instance = WorkflowMaxRuby::Projects::Pagination.new
  end
  ...
  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      expect(@instance).to be_instance_of(WorkflowMaxRuby::Projects::Pagination)
    end
  end
